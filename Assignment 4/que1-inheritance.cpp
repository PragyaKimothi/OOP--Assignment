...
ANSWER:
Inheritance is a key concept in object oriented programming . Inheritance allows developers to create derived classes (subclass) that reuse code declared already in a base class (superclass). Avoiding the
